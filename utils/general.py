...
def colorstr(*input):
    ...
    *args, string = input if len(input) > 1 else ('bright_blue', 'bold', input[0])  # color arguments, string
    colors = {
        'yellow': '\033[33m',
        'bright_blue': '\033[94m',
        'bright_cyan': '\033[96m',
...
def xyn2xy(x, w=320, h=320, padw=0, padh=0):
...
def segment2box(segment, width=320, height=320):
