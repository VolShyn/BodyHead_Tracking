    ...
    for frame_idx, (path, img, im0s, vid_cap, s) in enumerate(dataset):
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            if det is not None and len(det):
                ...
                LOGGER.info(f'YOLO:({t3 - t2:.3f}s), DeepSort:({t5 - t4:.3f}s)')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--yolo_model', nargs='+', type=str, default='bodyhead.pt', help='model.pt path(s)')
    ...
    parser.add_argument('--evaluate', action='store_false', help='augmented inference')
    parser.add_argument("--config_deepsort", type=str, default="deep_sort/configs/deep_sort.yaml")
    parser.add_argument("--half", action="store_true", help="use FP16 half-precision inference")
    parser.add_argument('--visualize', action='store_true', help='visualize features')
    parser.add_argument('--max-det', type=int, default=1000, help='maximum detection per image')
    parser.add_argument('--dnn', action='store_true', help='use OpenCV DNN for ONNX inference')
    parser.add_argument('--project', default='', action='store_false', help='save results to project/name')
    parser.add_argument('--name', default='', action='store_false', help='save results to project/name')
